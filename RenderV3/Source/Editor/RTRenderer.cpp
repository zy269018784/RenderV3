...
RTRenderer::RTRenderer(QVulkanWindow* w, bool msaa)
    : m_window(w)
{
    if (msaa) {
...
VkShaderModule RTRenderer::createShader(const QString& name)
{
    QFile file(name);
...
void RTRenderer::initSwapChainResources()
{
...
void RTRenderer::releaseSwapChainResources()
{
...
void RTRenderer::startNextFrame()
{
    VkDevice dev = m_window->device();
