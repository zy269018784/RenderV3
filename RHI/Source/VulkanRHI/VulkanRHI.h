...
#include <VulkanRHI/VulkanObjects/VulkanQueue.h>
#include <VulkanRHI/VulkanObjects/VulkanSwapChain.h>
#include <VulkanRHI/VulkanObjects/VulkanCommandPool.h>
...
#include <VulkanRHI/VulkanObjects/VulkanPipelineLayout.h>
#include <VulkanRHI/VulkanObjects/VulkanPipelineCache.h>
#include <VulkanRHI/VulkanObjects/VulkanDescriptorPool.h>
#include <VulkanRHI/VulkanObjects/VulkanDescriptorSet.h>
#include <VulkanRHI/VulkanObjects/VulkanDescriptorSetLayout.h>
#include <VulkanRHI/VulkanObjects/VulkanBuffer.h>
#include <VulkanRHI/VulkanObjects/VulkanSemaphore.h>
#include <VulkanRHI/VulkanObjects/VulkanFence.h>
#ifdef USE_QT
...
public:
	VulkanRHI(int GpuIndex = 0);
#ifdef USE_QT
	VulkanRHI(QVulkanWindow *window);
#endif
