...
public:
    ...
    QPB_PROTOBUFWELLKNOWNTYPES_EXPORT const MethodRepeated &methods() const &;
    ...
    QPB_PROTOBUFWELLKNOWNTYPES_EXPORT const MixinRepeated &mixins() const &;
    ...
    QPB_PROTOBUFWELLKNOWNTYPES_EXPORT void setMethods(const MethodRepeated &methods);
    QPB_PROTOBUFWELLKNOWNTYPES_EXPORT void setMethods(MethodRepeated &&methods);
    ...
    QPB_PROTOBUFWELLKNOWNTYPES_EXPORT void setMixins(const MixinRepeated &mixins);
    QPB_PROTOBUFWELLKNOWNTYPES_EXPORT void setMixins(MixinRepeated &&mixins);
