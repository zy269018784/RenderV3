...
public:
    ...
    QPB_PROTOBUFWELLKNOWNTYPES_EXPORT const FieldRepeated &fields() const &;

    QPB_PROTOBUFWELLKNOWNTYPES_EXPORT const QStringList &oneofs() const &;

    QPB_PROTOBUFWELLKNOWNTYPES_EXPORT const OptionRepeated &options() const &;
    ...
    QPB_PROTOBUFWELLKNOWNTYPES_EXPORT void setFields(const FieldRepeated &fields);
    QPB_PROTOBUFWELLKNOWNTYPES_EXPORT void setFields(FieldRepeated &&fields);
    ...
    QPB_PROTOBUFWELLKNOWNTYPES_EXPORT void setOptions(const OptionRepeated &options);
    QPB_PROTOBUFWELLKNOWNTYPES_EXPORT void setOptions(OptionRepeated &&options);
...
public:
    ...
    QPB_PROTOBUFWELLKNOWNTYPES_EXPORT const EnumValueRepeated &enumvalue() const &;
    ...
    QPB_PROTOBUFWELLKNOWNTYPES_EXPORT void setName(const QString &name);
    QPB_PROTOBUFWELLKNOWNTYPES_EXPORT void setName(QString &&name);
    QPB_PROTOBUFWELLKNOWNTYPES_EXPORT void setEnumvalue(const EnumValueRepeated &enumvalue);
    QPB_PROTOBUFWELLKNOWNTYPES_EXPORT void setEnumvalue(EnumValueRepeated &&enumvalue);
    QPB_PROTOBUFWELLKNOWNTYPES_EXPORT void setOptions(const OptionRepeated &options);
    QPB_PROTOBUFWELLKNOWNTYPES_EXPORT void setOptions(OptionRepeated &&options);
    QPB_PROTOBUFWELLKNOWNTYPES_EXPORT void setSourceContext(const SourceContext &sourceContext);
    QPB_PROTOBUFWELLKNOWNTYPES_EXPORT void setSourceContext(SourceContext &&sourceContext);
